...
parser.add_argument('-g', '--gene_loc', type = str, help = 'location of gene list file (string)')
...
parser.add_argument('-l', '--limix_annotation_loc', type = str, help = 'location of original feature annotations')
